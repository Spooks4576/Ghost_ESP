...
static void scroll_terminal_up(void) {
  ...
  lv_obj_scroll_by(terminal_textarea, 0, font_height * scroll_amount,
                   LV_ANIM_OFF);
}
...
void terminal_view_create(void) {
  ...
  lv_obj_set_style_bg_opa(terminal_textarea, LV_OPA_TRANSP,
  ...
  lv_obj_add_flag(terminal_textarea,
                  LV_OBJ_FLAG_SCROLL_CHAIN); // Enable scroll chain
  lv_obj_clear_flag(terminal_textarea,
                    LV_OBJ_FLAG_CLICKABLE); // Disable clicking
