...
bool joystick_just_pressed(joystick_t *joystick) {
    ...
    if (btn_state && !joystick->pressed) {
        joystick->hold_init = esp_timer_get_time() / 1000;  // Get time in milliseconds
