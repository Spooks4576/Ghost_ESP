...
esp_err_t led_strip_new_rmt_device(const led_strip_config_t *led_config, const led_strip_rmt_config_t *rmt_config, led_strip_handle_t *ret_strip) {
    ...
    rmt_clock_source_t clk_src = rmt_config->clk_src ? rmt_config->clk_src : RMT_CLK_SRC_DEFAULT;

    size_t mem_block_symbols = rmt_config->mem_block_symbols ? rmt_config->mem_block_symbols : LED_STRIP_RMT_DEFAULT_MEM_BLOCK_SYMBOLS;
