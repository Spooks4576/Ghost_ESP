...
static const char *TAG = "ST7735_DRIVER";
static esp_lcd_panel_handle_t panel_handle = NULL;
static esp_lcd_panel_io_handle_t io_handle = NULL;

static esp_err_t st7735_init(void) {
    ESP_LOGI(TAG, "Initializing SPI bus for ST7735");
    ...
    ESP_LOGI(TAG, "Setting up panel IO for ST7735");
    ...
    ESP_LOGI(TAG, "Configuring ST7735 panel");
    ...
    ESP_LOGI(TAG, "Resetting ST7735 panel");
    ...
    ESP_LOGI(TAG, "Additional configurations for ST7735 panel");
    ...
    ESP_LOGI(TAG, "Turning on the ST7735 display");
    ESP_ERROR_CHECK(esp_lcd_panel_disp_on_off(panel_handle, true));

    
    ESP_LOGI(TAG, "Turning on backlight for ST7735");
