 ...
 * @return esp_err_t ESP_OK on success, or appropriate error code
 */
esp_err_t ch422g_write_output_reg(esp_io_expander_ch422g_t *dev, uint32_t value);
 ...
 * @return esp_err_t ESP_OK on success, or appropriate error code
 */
esp_err_t ch422g_read_output_reg(esp_io_expander_ch422g_t *dev, uint32_t *value);
 ...
 * @return esp_err_t ESP_OK on success, or appropriate error code
 */
esp_err_t ch422g_write_direction_reg(esp_io_expander_ch422g_t *dev, uint32_t value);
 ...
 * @return esp_err_t ESP_OK on success, or appropriate error code
 */
esp_err_t ch422g_read_direction_reg(esp_io_expander_ch422g_t *dev, uint32_t *value);
