...
AsyncWebServerRequest::AsyncWebServerRequest(AsyncWebServer* s, AsyncClient* c)
  ...
  , _contentLength(0)
  , _parsedLength(0)
  , _headers(WebServer::LinkedList<AsyncWebHeader *>([](AsyncWebHeader *h){ delete h; }))
  , _params(WebServer::LinkedList<AsyncWebParameter *>([](AsyncWebParameter *p){ delete p; }))
  , _pathParams(WebServer::LinkedList<String *>([](String *p){ delete p; }))
  , _multiParseState(0)
  , _boundaryPosition(0)
  , _itemStartIndex(0)
  , _itemSize(0)
